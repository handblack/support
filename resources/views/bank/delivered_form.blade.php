...
@if($mode == 'new') 
<form class="form-horizontal" action="{{ route('delivered.store') }}" method="POST">
@elseif($mode == 'edit')
<form class="form-horizontal" action="{{ route('delivered.update',$row->id) }}" method="POST">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-footer">
                <a href="{{ route('delivered.index') }}" class="btn btn-danger"><i class="fas fa-times"></i> Cancelar</a>
