    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block active">
            <a href="{{ route('pos.run') }}" class="nav-link">
                <i class="far fa-circle"></i> Punto de Venta
            </a>
        </li>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <a href="#" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                <img src="{{ asset('images/user_red.png') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <a href="#" class="dropdown-item">
                <!-- Message Start -->
                <div class="media">
                <img src="{{ asset('images/user_red.png') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                    <h3 class="dropdown-item-title">
                    John Pierce
        ...
        <li class="nav-item">
            <a class="nav-link" href="#" role="button" data-toggle="modal" data-target="#ticket-bug-create">
